...
#include "drivers/contraction/chDijkstra_driver.h"
...
#include "contraction/pgr_chDijkstra.hpp"
...
pgr_chDijkstra(
    ...
    pgrouting::bidirectional::Pgr_chDijkstra<G> fn_chDijkstra(graph);
    ...
    if (combinations.empty()) {
        ...
        for (const auto source : sources) {
            for (const auto target : targets) {
                ...
                paths.push_back(fn_chDijkstra.pgr_chDijkstra(
